...
def get_config():
    ...
    parser.add_argument("--train_data",
                        default='../data/NewsPost/news_chunk_part_train_unnorm.csv', type=str)
    parser.add_argument("--valid_data",
                        default='../data/NewsPost/news_chunk_part_dev_unnorm.csv', type=str)
    parser.add_argument("--test_data",
                        default='../data/NewsPost/news_chunk_part_test_unnorm.csv', type=str)
    # parser.add_argument("--embedding_path",
    #                     default='E:\DATASET\Embedding\cbow_news_300d_30e.txt', type=str)
    parser.add_argument("--embedding_path",
                        default="../maryam.najafi/Embeddings/cbow_news_300d_30e.txt", type=str)

    parser.add_argument("--model_name_config_path",
                        default='../data/DataUsage/model_name_config.json', type=str)

    # ----------------------------------- Model -----------------------------------
    parser.add_argument("--model_root", default='', type=str)
    parser.add_argument("--loss_curve_path",
                        default='../models/ID_x/Curves/loss_curve.png', type=str)
    parser.add_argument("--accuracy_curve_path",
                        default='../models/ID_x/Curves/accuracy_curve.png', type=str)
    parser.add_argument("--text_field_path", default="../models/ID_x/Fields/text_field", type=str)
    parser.add_argument("--label_field_path", default="../models/ID_x/Fields/label_field", type=str)
    parser.add_argument("--pos_field_path", default="../models/ID_x/Fields/pos_field", type=str)
    parser.add_argument("--lemma_field_path", default="../models/ID_x/Fields/lemma_field", type=str)
    parser.add_argument("--cm_path", default='../models/ID_x/Curves/cm.png', type=str)
    parser.add_argument("--log_path", default="../models/ID_x/Logs/log.txt", type=str)
    parser.add_argument("--model_path", default="../models/ID_x/", type=str)
    parser.add_argument("--final_model_path", default="../models/ID_x/final_model.pt", type=str)
