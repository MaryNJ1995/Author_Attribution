...
if __name__ == "__main__":
    ...
    BERT_TOKENIZER = BertTokenizer.from_pretrained(os.path.join(CONFIG.assets_dir, CONFIG.bert_tokenizer_path))
    ...
    DATA_MODULE = DataModule(train_data=TRAIN_DATA, val_data=VAL_DATA, test_data=TEST_DATA,
                             tokenizer=BERT_TOKENIZER, batch_size=CONFIG.batch_size,
